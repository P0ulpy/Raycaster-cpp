...
public:
    ...
    static sf::Vector2f fromAngle(float radAngle, float length = 1);
    static double dist(const sf::Vector2f& a, const sf::Vector2f& b);
    static double mag(const sf::Vector2f& v);
    static double magSq(const sf::Vector2f& v);
    static double map(double n, double start1, double end1, float start2, float end2, bool withinBounds = false);
    static double constrain(double n, double low, double high);
    static double heading(const sf::Vector2f& v);
